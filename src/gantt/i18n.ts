...
export const G = {
  ...
  g_alert_overrun:  { he: 'התראה על חריגה',                en: 'Alert on overrun' },
  g_alert_hint:     { he: 'אם תאריך הסיום יעבור והמשימה לא הושלמה — תישלח התראה לאדמין, למנהלים ולמנהלי הפרויקט.',
                      en: 'If the finish date passes while the task is unfinished, admins, managers and this project’s managers are notified.' },
