...
export const D = {
  ...
  // admin form builder
  fb_kicker:           { he: 'ניהול · תפיסת סיום שלב', en: 'Admin · Stage-gate close-out' },
  fb_title:            { he: 'בונה טופס ליקויים', en: 'Defect form builder' },
  fb_intro:            { he: "עריכת סעיפי הצ'קליסט לכל השערים: שינוי נוסח, השבתת סעיף או הוספת סעיף חדש. השינויים חלים על כל הלולים (חדשים וקיימים).", en: 'Edit the checklist items of every gate: change wording, disable an item or add a new one. Changes apply to all coops (new and existing).' },
  fb_loading:          { he: 'טוען…', en: 'Loading…' },
  fb_restore:          { he: '↺ מקורי', en: '↺ Original' },
  fb_restore_title:    { he: 'חזרה לנוסח המקורי', en: 'Restore the original wording' },
  fb_enable:           { he: 'הפעלה', en: 'Enable' },
  fb_disable:          { he: 'השבתה', en: 'Disable' },
  fb_added:            { he: 'נוסף', en: 'Added' },
  fb_delete:           { he: 'מחיקה', en: 'Delete' },
  fb_new_ph:           { he: 'נוסח סעיף חדש לשער הזה…', en: 'Wording of a new item for this gate…' },
  fb_add:              { he: '✛ הוספת סעיף', en: '✛ Add item' },
