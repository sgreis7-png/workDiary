...
const D = {
  ...
  rep_send_email:    { he: 'שליחה במייל', en: 'Send by email' },
  rep_email_ph:      { he: 'כתובות מייל לשליחה (מופרדות בפסיק):', en: 'Recipient emails (comma-separated):' },
  rep_email_bad:     { he: 'לא זוהו כתובות מייל תקינות', en: 'No valid email addresses' },
  rep_email_sent:    { he: '✓ הדוח נשלח במייל', en: '✓ Report sent by email' },
