...
const STRINGS = {
  ...
  confirm_delete_project: { he: 'למחוק פרויקט זה לצמיתות? פעולה זו אינה הפיכה.', en: 'Delete this project permanently? This cannot be undone.' },
  project_has_entries: { he: 'לא ניתן למחוק — לפרויקט יש רשומות. יש להפוך אותו ללא פעיל במקום.', en: 'Cannot delete — this project has entries. Deactivate it instead.' },
