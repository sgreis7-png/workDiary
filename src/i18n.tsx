...
export const STRINGS = {
  ...
  rule_overdue_hint: { he: 'בכל שעה נבדק אם עבר תאריך הסיום של משימה שטרם הושלמה. ההתראה נשלחת אליך, פעם אחת לכל משימה.',
                       en: 'Every hour, tasks whose finish date has passed while unfinished are checked. You are notified once per task.' },
